...
class Alphas(object):
    ...
    def get_benchmark(cls, year, code):
        ...
        data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)),'index')
    ...
    def generate_alpha_single(cls, alpha_name, year, list_assets, benchmark, need_save=False):
        ...
        if need_save:
            path = os.path.join(os.path.dirname(os.path.abspath(__file__)),f'alphas/{cls.__name__}/{year}')
